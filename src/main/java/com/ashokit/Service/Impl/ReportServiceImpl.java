...
public class ReportServiceImpl implements ReportService {
	...
	public List<InsurancePolicy> search(SearchRequest request) {
		...
		if (null != request.getPlanEndDate() && !"".equals(request.getPlanEndDate())) {
			...
			DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dds");
	...
	public boolean exportPdf(HttpServletResponse response) throws Exception {
		...
		String to = "bairiswaraj016@gmail.com";
		attachments.sendEmailPdf(subject, body, to, file);
		file.delete();
		return true;
	}
	...
	public boolean exportExcel(HttpServletResponse response) throws Exception {
		...
		String body = "<h1>test mail body";
		String to = "bairiswaraj016@gmail.com";
		attachments.sendEmail(subject, body, to, file);
		file.delete();
		return true;
